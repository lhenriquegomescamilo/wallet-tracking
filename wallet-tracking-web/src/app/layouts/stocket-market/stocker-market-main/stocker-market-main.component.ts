...
@Component({
  selector: 'app-stocker-market-main',
  templateUrl: './stocker-market-main.component.html',
  styleUrls: ['./stocker-market-main.component.scss']
})
export class StockerMarketMainComponent implements OnInit {
